            ...
            <div className='pb-5'>
                <div className='flex justify-between items-center'>
                    ...
                    <div className='relative group'>
                        ...
                        <div className='absolute top-full right-0 z-20 w-32 p-5 mt-2 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block'>
                 ...
                 {/* For search box search user and icon */}
